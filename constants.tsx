...
export const SEARCH_ITEMS = [
  ...
  { id: 'o1', type: 'order', title: 'سفارش #12890', subtitle: 'میز 5', detail: 'در انتظار', status: 'new', keywords: 'سفارش میز 5 در انتظار جدید order table 5 wait' },
  { id: 'o2', type: 'order', title: 'سفارش #12891', subtitle: 'میز 12', detail: 'در حال آماده‌سازی', status: 'preparing', keywords: 'سفارش میز 12 در حال آماده‌سازی آماده سازی آماده سازی سفارش order table 12 prep' },
  { id: 'o3', type: 'order', title: 'سفارش #12888', subtitle: 'میز 8', detail: 'آماده تحویل', status: 'ready', keywords: 'سفارش میز 8 آماده تحویل آماده تحویل آماده سفارش order table 8 ready' },
